...
def segs(array):
    ...
    df.to_csv("CSVdata/Fortuna/hop53/angle.csv", encoding='utf-8', index=False)
...
def fileread(file):
    ...
    with open(file,'r') as csvFile:
        ...
        for row in csvReader: #reading in all the points from the file
            pt1X.append(float(row[0])-0.002)
            pt1Y.append(float(row[1])-0.002)
            pt1Z.append(float(row[2])-0.002)
            pt2X.append(float(row[3])-0.002)
            pt2Y.append(float(row[4])-0.002)
            pt2Z.append(float(row[5])-0.002)
            pt3X.append(float(row[6])-0.002)
            pt3Y.append(float(row[7])-0.002)
            pt3Z.append(float(row[8])-0.002)
            pt4X.append(float(row[9])-0.002)
            pt4Y.append(float(row[10])-0.002)
            pt4Z.append(float(row[11])-0.002)
            pt5X.append(float(row[12])-0.002)
            pt5Y.append(float(row[13])-0.002)
            pt5Z.append(float(row[14])-0.002)
            pt6X.append(float(row[15])-0.002)
            pt6Y.append(float(row[16])-0.002)
            pt6Z.append(float(row[17])-0.002)
    ...
    return AlltehPoints
def main():
    allpoints=fileread("CSVdata/Fortuna/hop53/Hop53DLTdv5_data_xyzpts.csv")
    segs(allpoints)
